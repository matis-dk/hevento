                ...
                <nav id="header-navigation">
                    <?php
                        if ($_SESSION['userSignin']) {
                            include(PRIVATE_PATH . '/components/header-signin.php');
                        } else {
                            include(PRIVATE_PATH . '/components/header-signout.php');
                        };
                    ?>
                </nav>
            </div>
